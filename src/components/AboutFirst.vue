<template>
  ...
  <div class="row ">
    <div class="col ">
      <div class="background-div d-block d-sm-none vertical-center pt-5 ">
        <!-- Content goes here -->

        <h1 class="mt-5 container">We offer a wide range of products and services
</h1>
<p class="container">medical training,diagnostic equipment,updates on medical

breakthrough studies and medical conferences</p>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active container-fluid">
      ...
      <div class="carousel-caption d-none d-md-block check-car">
...
.background-div {
      ...
      background-image: url('../assets/Frame\ 112.png'); /* Replace 'path/to/your/image.jpg' with the path to your image */
